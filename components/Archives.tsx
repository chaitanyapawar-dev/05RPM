...
export const caseStudies: CaseStudyType[] = [
  ...
  {
    main_image_src: "/projects/allswift.png",
    ...
    case_study_link: "#",
    name: "Allswift Solutions",
    demo_images: ["/projects/project2.webp"],
  },
  {
    main_image_src: "/projects/tnpshostel.png",
    project_title: "TNPS boys hostel league app with leaderboard and team details",
    logo_src: "",
    image_fit: "contain",
    description: "A legacy inter-hostel league featuring seven teams in a new franchise model, competing across sports, E-sports, and cultural events.",
    features: [
    ...
    case_study_link: "#",
    name: "TNPS Hostel League App",
    demo_images: ["/projects/league2.webp",
      "/projects/league.webp",
    ],
  },
  {
    main_image_src: "/projects/algo.png",
